 ...
 * Operations may ffmpeg.include channel conversion, data format conversion and/or sample rate conversion.
 */
...
public:
    ...
    ResultWithValue<double> calculateLatencyMillis() override {
        // This will automatically ffmpeg.include the latency of the flowgraph?
